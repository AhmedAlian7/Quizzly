...
namespace Quizzly.DataAccess.Migrations
{
    ...
    [Migration("20251005142538_AddIdentityAndStudent")]
    partial class AddIdentityAndStudent
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Quizzly.DataAccess.Entities.Instructor", b =>
                {
                    b.HasBaseType("Quizzly.DataAccess.Entities.ApplicationUser");
            ...
            modelBuilder.Entity("Quizzly.DataAccess.Entities.Instructor", b =>
                {
                    b.HasOne("Quizzly.DataAccess.Entities.ApplicationUser", "User")
                        .WithOne("Instructor")
                        .HasForeignKey("Quizzly.DataAccess.Entities.Instructor", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Quizzly.DataAccess.Entities.Student", b =>
                {
                    b.HasOne("Quizzly.DataAccess.Entities.ApplicationUser", "ApplicationUser")
                        .WithOne("Student")
                        .HasForeignKey("Quizzly.DataAccess.Entities.Student", "UserId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
